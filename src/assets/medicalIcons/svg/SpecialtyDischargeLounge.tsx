...
const SvgSpecialtyDischargeLounge = (props: SVGProps<SVGSVGElement>) => (
  <Svg
    ...
    viewBox="0 0 48 48"
    {...props}>
    <Path fill="#333" d="M23 11v3h-3v2h3v3h2v-3h3v-2h-3v-3h-2Z" />
    <Path
      fill="#333"
      fillRule="evenodd"
...
export default SvgSpecialtyDischargeLounge;
