...
import AddressListEntry from '@screens/app/common/address/AddressListEntry';
...
export const DetailAddress: React.FC<Props> = (props: Props) => {
  // @ts-ignore
    ...
    <View style={styles.contents}>
      <View style={styles.reviews}>
        <View style={styles.entries}>
          {data &&
            data.entries &&
            data.entries.map((it: any) => {
              console.log(it);
              return (
                <AddressListEntry
                  title={it?.organization?.nameText}
                  showAddress={true}
                  showDistanceAway={true}
                  address={it?.organization?.mainAddress}
                />
              );
            })}
        </View>
